...
public class HealthClinicTestJUnit {
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/dane.csv", numLinesToSkip = 1, delimiter = ';')
    public void analyzeHealthByVitalSigns_withDataFromFileCSV_resultFromData(Integer systolicBloodPressure, Integer diastolicBloodPressure, Integer pulse, boolean expectedResult){
